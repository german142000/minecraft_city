...
class Cube {
public:
	int packetId; //Номер пакета ресурсов, к которуму принадлежит блок. Все идентификаторы, перечисленные ниже, являются дочерними идентификаторами пакета ресурсов
	...
	int soundId; //Звук, воспроизводящийся при взаимодействии с блоком
};